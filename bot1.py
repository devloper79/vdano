...
class Bot(discord.Client):
    ...
    async def update_embeds(self):
       ...
       #global wrong             
        ...
        if highest > 0:
            if answer == 1:
                one_check = "<:emoji_1:729936389235277824>"
                mark_check_one = ""
            ...
            if answer == 2:
                two_check = "<:emoji_1:729936389235277824>"
                mark_check_two = ""
            ...
            if answer == 3:
                three_check = "<:emoji_1:729936389235277824>"
                mark_check_three = ""
        ...
        self.embed.set_field_at(0, name="**__Answer 1__**", value="**{0}**{1}{2}".format(lst_scores[0], one_check, one_cross)) 
        self.embed.set_field_at(1, name="**__Answer 2__**", value="**{0}**{1}{2}".format(lst_scores[1], two_check, two_cross)) 
        self.embed.set_field_at(2, name="**__Answer 3__**", value="**{0}**{1}{2}".format(lst_scores[2], three_check, three_cross)) 
    ...
    async def on_ready(self):
        ...
        await self.change_presence(activity=discord.Activity(type=1,name='With Vedantu Answers!!'))
        await asyncio.sleep(5)
...
def bot_with_cyclic_update_process(update_event, answer_scores):
    ...
    loop.create_task(bot.start('NzI5OTc2Mjk0NDI2NjczMTUz.XwQ1rw.8ZCrFEkJmu5dCib4XxFL-MLWveY'))
    loop.run_forever()
...
def selfbot_process(update_event, answer_scores):
    ...
    loop = asyncio.get_event_loop()
    loop.create_task(selfbot.start('Njg2NjE3MzE2MTE2NjYwMzc5.Xt8rsA.pxQOysQpS2n_Op56iSBsv3jhqIo',
                                     bot=False))
    loop.run_forever()
